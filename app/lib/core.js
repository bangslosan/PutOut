...
var APP = {
	...
	loadContent: function() {
		...
		if(OS_IOS) {
			APP.MainWindow.statusBarStyle = /*APP.Settings.colors.theme == "dark" ?*/
			Ti.UI.iPhone.StatusBar.LIGHT_CONTENT /*: Ti.UI.iPhone.StatusBar.DEFAULT*/
			;
		}
	},
	/**
	...
	build: function() {
		...
		if(APP.Settings.useSlideMenu) {
			...
			nodes.push({
				...
				menuHeader: hasMenuHeaders ? "Other" : null
			});
